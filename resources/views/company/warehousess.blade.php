          ...
          <div class="row d-flex align-items-stretch">
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Warehouses</b></h2>
                      <p class="text-muted text-sm"><b>About: </b>Warehouses for Development and Investment (known as: Warehouses) is a public company listed on the ASE since January 2019. Warehouses operates </p>
