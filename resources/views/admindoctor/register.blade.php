        ...
        <div class="login100-form-title" style="background-image: url(img/doc.jpg);">
         ...
         <form class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
            <span class="label-input100">Name Clinic</span>
            <input class="input100" type="text" name="Clinic" placeholder="Name Clinic">
            <span class="focus-input100"></span>
          </div>

           <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
            <span class="label-input100">Membership No</span>
            <input class="input100" type="text" name="Membership" placeholder="Membership No">
            <span class="focus-input100"></span>
          </div>
